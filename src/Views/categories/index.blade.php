...
<div class="uk-container uk-container-large">
    <div class="uk-child-width-1-3@l uk-child-width-1-2@m uk-child-width-1-1@s uk-grid-match" uk-grid>
        @foreach ($categories as $category)
            <div>
                <a href="{{ route('laralum::forum.categories.show', ['category' => $category->id]) }}" class="uk-link-reset">
                    <div class="uk-card uk-card-default uk-card-hover uk-card-body">
                        ...
                        <div class="uk-align-right">
                            <a class="uk-link-reset" href="{{ route('laralum::forum.categories.edit', ['id' => $category->id]) }}">
                                <i style="font-size:20px;" class="icon ion-edit"></i>
                            </a>
                            &nbsp;
                            <a class="uk-link-reset" href="{{ route('laralum::forum.categories.destroy.confirm', ['id' => $category->id]) }}">
