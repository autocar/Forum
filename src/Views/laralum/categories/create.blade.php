            ...
            <div class="uk-width-1-1@s uk-width-3-5@l uk-width-1-3@xl">
                <div class="uk-card uk-card-default">
                    <div class="uk-card-header">
                        {{ __('laralum_forum::general.create_category') }}
                    </div>
                    <div class="uk-card-body">
                        <form class="uk-form-stacked" method="POST" action="{{ route('laralum::forum.categories.store') }}">
                            {{ csrf_field() }}
                            <fieldset class="uk-fieldset">
                                ...
                                <div class="uk-margin">
                                    ...
                                    <div class="uk-form-controls">
                                        <input value="{{ old('name') }}" name="name" class="uk-input" type="text" placeholder="@lang('laralum_forum::general.name')">
                                    </div>
                                </div>

                                <div class="uk-margin">
                                    <button type="submit" class="uk-button uk-button-primary uk-align-right">
                                        <span class="ion-forward"></span>&nbsp; {{ __('laralum_forum::general.create_category') }}
                                    </button>
                                </div>
                            </fieldset>
                        </form>
